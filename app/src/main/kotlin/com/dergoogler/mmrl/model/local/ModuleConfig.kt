...
//import com.dergoogler.mmrl.model.ConfigFile
...
//    val __module__identifier__: String,
//    @Json(name = "name")
//    val nam: Any? = null,
...
//    override fun getModuleId(): ModId = ModId(__module__identifier__)
//
...
//
//    override fun getDefaultConfigFactory(id: ModId): ModuleConfig = ModuleConfig(id.toString())
//
...
//}
//
//private val moduleConfigCache = ConcurrentHashMap<String, ModuleConfig>()
//
//val LocalModule.ModuleConfig: ConfigFile<ModuleConfig>
//    get() = moduleConfigCache.getOrPut(id) { ModuleConfig(id) }
//
//fun LocalModule.toModuleConfigState(): StateFlow<ModuleConfig> = ModuleConfig.getConfigStateFlow()
//
//fun LocalModule.toModuleConfig(disableCache: Boolean = false): ModuleConfig =
//    ModuleConfig.getConfig(disableCache)
